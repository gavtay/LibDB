...
CREATE TABLE IF NOT EXISTS LibDB.Client (
    ClientID INT,
    ClientFirstName VARCHAR(20) CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS LibDB.Borrower (
    BorrowID INT,
    ClientID INT,
    BookID INT,
    BorrowDate DATE
...
CREATE TABLE IF NOT EXISTS LibDB.Book (
    BookID INT,
...
CREATE TABLE IF NOT EXISTS LibDB.Author (
    AuthorID INT,
